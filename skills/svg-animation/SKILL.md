...
(`research/svg-animation/`, ten recorded trials), the defects classified by what was actually
missing:
...
The tooling used to produce this skill's evidence lives in `research/svg-animation/`:
