...
`#tags` — and its words are counted against two closed lists of function words, one per language,
...
word at all is **skipped and counted**, never passed. A comment or docstring reads as the wrong
...
exists at the repository root. All four are silent without the declaration.
