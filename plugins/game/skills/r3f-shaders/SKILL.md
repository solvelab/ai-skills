...
| Reference | Covers |
|---|---|
| [shaderMaterial (Drei)](references/shadermaterial-drei.md) | Quick Start, shaderMaterial (Drei) |
| [Uniforms](references/uniforms.md) | Raw THREE.ShaderMaterial, Uniforms, Varyings |
| [Common Shader Patterns](references/common-shader-patterns.md) | Common Shader Patterns |
| [Instanced Shaders](references/instanced-shaders.md) | Extending Built-in Materials, GLSL Built-in Functions, Instanced Shaders, External Shader Files, Material Properties, Debugging Shaders, Performance Tips |
