...
declare -A GROUP_DESC=(
  ...
  [workflow]="Commit format, OpenSpec spec-driven workflow and the anti-guessing rite (conventional-commit, openspec, openspec-drivezone, verify-before-claiming)"
