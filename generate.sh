...
declare -A GROUP_DESC=(
  ...
  [workflow]="Commit format, OpenSpec spec-driven workflow, the anti-guessing rite and the code-locale rule (conventional-commit, openspec, openspec-drivezone, verify-before-claiming, code-locale)"
