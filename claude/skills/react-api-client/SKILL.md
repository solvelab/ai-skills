...
Read and follow all instructions in ~/ai-skills/skills/react-api-client/SKILL.md

Reference files are in ~/ai-skills/skills/react-api-client/references/ — read them when the skill instructions point to them.
