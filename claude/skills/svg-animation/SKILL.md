...
Read and follow all instructions in ~/ai-skills/skills/svg-animation/SKILL.md

Reference files are in ~/ai-skills/skills/svg-animation/references/ — read them when the skill instructions point to them.
