...
Read and follow all instructions in ~/ai-skills/skills/r3f-interaction/SKILL.md

Reference files are in ~/ai-skills/skills/r3f-interaction/references/ — read them when the skill instructions point to them.
