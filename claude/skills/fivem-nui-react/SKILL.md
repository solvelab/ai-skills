...
Read and follow all instructions in ~/ai-skills/skills/fivem-nui-react/SKILL.md

Reference files are in ~/ai-skills/skills/fivem-nui-react/references/ — read them when the skill instructions point to them.
