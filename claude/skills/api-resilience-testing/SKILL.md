...
Read and follow all instructions in ~/ai-skills/skills/api-resilience-testing/SKILL.md

Reference files are in ~/ai-skills/skills/api-resilience-testing/references/ — read them when the skill instructions point to them.
